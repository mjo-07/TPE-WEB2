...
create table editor (
    ...
    constraint CK_VALORACION_EDITOR check (
...
create table video_juego (
    ...
    constraint VIDEO_JUEGO_EDITOR foreign key (id_editor) references editor (id_editor) on delete restrict on update cascade,
    constraint CK_PRECIO_POSITIVO check (`precio` >= 0),
    constraint CK_VALORACION check (
        `valoracion` between 0 and 5
    )
);
--Inserts Categoria
...
VALUES (
        ...
        5,
        '1779674978_HDshueDbgAACA1U.jpg'
    );
INSERT INTO editor (
        nombre_empresa,
        descripcion,
...
VALUES (
        ...
        'http://www.ea.com',
        5,
        '1779674995_ea-featured-image-generic-brand-logo.png.adapt.crop16x9.1023w.png'
    );
INSERT INTO editor (
        nombre_empresa,
        descripcion,
...
VALUES (
        ...
        2,
        '1779675028_amanita-design-og-image.jpg'
    );
INSERT INTO editor (
        nombre_empresa,
        descripcion,
...
VALUES (
        ...
        'Simulador de conducción de camiones',
        10.23,
        ...
        '2012-05-03',
        5,
        '1779679606_Euro-Truck-Simulator-2-cover.jpg',
        1
    );
INSERT INTO video_juego (
        titulo,
...
VALUES (
        ...
        'Deportes, Fútbol',
        89.90,
        'Juega a tu manera en EA SPORTS FC™ 26 con regates más ágiles, una posición más inteligente de la IA y movimientos más nítidos y explosivos, todo basado en los comentarios de la comunidad. Los guardametas ahora reaccionan de manera más natural con una posición mejorada, las animaciones son más realistas, y los nuevos estilos de juego y roles de jugadores te ofrecen más formas de definir cómo juega tu equipo. ',
        '2026-02-05',
        5,
        '1779679624_fifa26_acab26b6-032f-420d-8c7e-d81cc495b795.webp',
        2
    );
INSERT INTO video_juego (
        titulo,
...
VALUES (
        ...
        '2003-10-29',
        5,
        '1779679639_Store_BO6PDP_Hero.webp',
        3
    );
INSERT INTO video_juego (
        titulo,
